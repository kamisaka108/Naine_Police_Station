...
export const dispatchData = {
  ...
  surface: {
    title: "緊急出動要請 (一般)",
    incidentTypes: ["近隣トラブル (邻里纠纷)", "不審者通報 (可疑人员)", "器物損壊 (破坏公物)", "その他 (其他)"],
    warning: "※ 虚偽の通報は法律により罰せられます。現場の状況により、到着まで時間がかかる場合があります。"
  },
  // 里层：懂得人都懂的“警车外卖”服务菜单
  secret: {
    title: "特別救済派遣 (Delivery Health)",
    services: [
      { id: 's1', name: "基本救済 (手口奉仕)", duration: "15分", price: 15000, desc: "パトカー内での素早い処理。前戯なし。" },
      { id: 's2', name: "標準救済 (本番行為)", duration: "45分", price: 35000, desc: "指定場所でのフルサービス。ゴム着用必須。" },
      { id: 's3', name: "深度救済 (中出し許可)", duration: "60分", price: 80000, desc: "危険日応相談。追加の性病検査費用が含まれます。" }
    ],
    addons: [
    ...
    warning: "※ 表示金額は基本料金（税込）です。現場での追加要求（延長、特殊プレイ、複数穴の同時使用など）により、派遣警察官から追加の請求（ポイントまたは現金）が発生する場合があります。売上の80%は署の運営費に、20%は担当警官の特別手当に充てられます。"
  }
};
